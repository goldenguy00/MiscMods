...
public class Mirror : BaseElite
{
	...
	public override void OnLoad()
	{
		...
		base.eliteDef.name = "RisingTides_Mirror";
		base.vanillaTier = 2;
		base.isHonor = false;
		...
		EliteRamp.AddRamp(base.eliteDef, RisingTidesPlugin.AssetBundle.LoadAsset<Texture2D>("Assets/Mods/RisingTides/Elites/Mirror/texAffixMirrorRecolorRamp.png"));
		base.modelEffect = RisingTidesPlugin.AssetBundle.LoadAsset<GameObject>("Assets/Mods/RisingTides/Elites/Mirror/AffixMirrorEffect.prefab");
		base.lightColorOverride = new Color32(254, byte.MaxValue, 204, byte.MaxValue);
		base.particleMaterialOverride = RisingTidesPlugin.AssetBundle.LoadAsset<Material>("Assets/Mods/RisingTides/Elites/Mirror/matAffixMirrorNegativeParticle.mat");
	...
	public override void AfterContentPackLoaded()
	{
		...
		ConfigurableValue.CreateBool("com.themysticsword.risingtides", "Rising Tides", RisingTidesPlugin.config, "Enabled Elites", "Phenakite", true, "", (List<string>)null, (ConfigEntry<bool>)null, false, (Action<bool>)delegate(bool newValue)
		{
			base.eliteDef.eliteEquipmentDef = (newValue ? RisingTidesContent.Equipment.RisingTides_AffixMirror : null);
		});
	}
}
