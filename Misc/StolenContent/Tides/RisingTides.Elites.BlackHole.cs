...
public class BlackHole : BaseElite
{
	...
	public override void OnLoad()
	{
		...
		base.eliteDef.name = "RisingTides_BlackHole";
		base.vanillaTier = 2;
		base.isHonor = false;
		...
		EliteRamp.AddRamp(base.eliteDef, RisingTidesPlugin.AssetBundle.LoadAsset<Texture2D>("Assets/Mods/RisingTides/Elites/BlackHole/texAffixBlackHoleRecolorRamp.png"));
		base.modelEffect = RisingTidesPlugin.AssetBundle.LoadAsset<GameObject>("Assets/Mods/RisingTides/Elites/BlackHole/AffixBlackHoleEffect.prefab");
		...
		base.lightColorOverride = new Color32(84, 0, byte.MaxValue, byte.MaxValue);
		base.particleMaterialOverride = RisingTidesPlugin.AssetBundle.LoadAsset<Material>("Assets/Mods/RisingTides/Elites/BlackHole/matAffixBlackHoleParticleOverride.mat");
	...
	public override void AfterContentPackLoaded()
	{
		...
		ConfigurableValue.CreateBool("com.themysticsword.risingtides", "Rising Tides", RisingTidesPlugin.config, "Enabled Elites", "Onyx", true, "", (List<string>)null, (ConfigEntry<bool>)null, false, (Action<bool>)delegate(bool newValue)
		{
			base.eliteDef.eliteEquipmentDef = (newValue ? RisingTidesContent.Equipment.RisingTides_AffixBlackHole : null);
		});
	}
}
