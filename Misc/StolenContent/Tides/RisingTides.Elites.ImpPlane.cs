...
public class ImpPlane : BaseElite
{
	...
	private sealed class _003C_003Ec
	{
		...
		internal void _003COnLoad_003Eb__0_2(CharacterModel model, GameObject effect)
		{
			...
			if ((bool)model.mainSkinnedMeshRenderer)
			{
	...
	public override void OnLoad()
	{
		...
		base.eliteDef.name = "RisingTides_ImpPlane";
		base.vanillaTier = 2;
		base.isHonor = false;
		...
		EliteRamp.AddRamp(base.eliteDef, RisingTidesPlugin.AssetBundle.LoadAsset<Texture2D>("Assets/Mods/RisingTides/Elites/ImpPlane/texAffixImpPlaneRecolorRamp.png"));
		base.modelEffect = RisingTidesPlugin.AssetBundle.LoadAsset<GameObject>("Assets/Mods/RisingTides/Elites/ImpPlane/AffixImpPlaneEffect.prefab");
		JitterBones jitterBones = base.modelEffect.AddComponent<JitterBones>();
		...
		jitterBones = base.modelEffect.AddComponent<JitterBones>();
		jitterBones.perlinNoiseFrequency = 20f;
		...
		base.lightColorOverride = new Color32(230, 0, 60, byte.MaxValue);
		base.particleMaterialOverride = RisingTidesPlugin.AssetBundle.LoadAsset<Material>("Assets/Mods/RisingTides/Elites/ImpPlane/matAffixImpPlaneSpikeVoidParticle.mat");
	...
	public override void AfterContentPackLoaded()
	{
		...
		ConfigurableValue.CreateBool("com.themysticsword.risingtides", "Rising Tides", RisingTidesPlugin.config, "Enabled Elites", "Realgar", true, "", (List<string>)null, (ConfigEntry<bool>)null, false, (Action<bool>)delegate(bool newValue)
		{
			base.eliteDef.eliteEquipmentDef = (newValue ? RisingTidesContent.Equipment.RisingTides_AffixImpPlane : null);
		});
	}
}
